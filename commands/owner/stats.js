...
//command
  if(message.author.id != 793111567184297985){
...
.setTitle(`**[Support Server]**`)
  .setDescription(`Hey My name is **${message.client.user.username}** and My Work is playing songs for u.`)
  ...
  .setColor("3498DB")
  .setFooter("Thx For Choosing Beats")  
